...
- [Cellular context of IL-33 expression dictates impact on anti-helminth immunity](../sources/2020_cellular_context_of_il_33_expression_dictates_impact_on_anti_helminth_immunity.md) adds a source-cell boundary to the IL-33 axis: epithelial IL-33 supported gut/MLN ILC2-associated anti-helminth type 2 immunity in mice, whereas CD11c+ APC-derived IL-33 supported ST2+GATA3+Foxp3+ Treg restraint. This is gut helminth evidence with human airway expression context, not direct lung-disease causality.
...
| [IL-33 source-cell context](../sources/2020_cellular_context_of_il_33_expression_dictates_impact_on_anti_helminth_immunity.md) | ILC2-linked type 2 response and ST2+GATA3+Foxp3+ Treg restraint | Gut / MLN; mouse lung APC expression context; human nasal airway expression context | Mouse primary; human expression context | N. brasiliensis and H. polygyrus bakeri anti-helminth immunity; CRSwNP expression context only | VillinCreER Il33 deletion, CD11cCre Il33 deletion, ST2+ Treg transfer, Foxp3Cre Gata3 deletion, Mpeg1/perforin-2 perturbation | Epithelial IL-33 supports ILC2-associated type 2 anti-helminth immunity, while CD11c+ APC IL-33 supports Treg-mediated restraint | Mainly intestinal/MLN helminth biology; do not convert to direct pulmonary IL-33/Treg disease causality. |
...
flowchart TB
    ...
    class cgrp,pac1,response,adm2,adm2r cue
