...
- [Interleukin-4-producing type 2 innate lymphoid cells in the lymph node promote proallergic Tfh13 cell differentiation](../sources/2026_interleukin_4_producing_type_2_innate_lymphoid_cells_in_the_lymph_node_promote_proall.md) adds a mouse airway-allergen branch in which CCR8-guided ILC2 entry into lung-draining lymph nodes and ILC2-derived IL-4 support Tfh13 differentiation, high-affinity IgE, and anaphylaxis-associated outputs; this is draining-lymph-node adaptive-immunity evidence, not direct human lung tissue evidence.
