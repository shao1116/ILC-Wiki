...
For disease outcomes, see [ILC3 Roles In Pulmonary Disease](./ILC3_roles_in_pulmonary_disease/).
...
- [Group 3 innate lymphoid cells secret neutrophil chemoattractants and are insensitive to glucocorticoid via aberrant GR phosphorylation](../sources/2023_group_3_innate_lymphoid_cells_secret_neutrophil_chemoattractants_and_are_insensitive/) supports a mechanism where ILC3 neutrophil chemoattractant production is glucocorticoid-insensitive and linked to altered glucocorticoid receptor phosphorylation.
...
- [ILC3](../entities/ILC3/)
- [ILC3 Roles In Pulmonary Disease](./ILC3_roles_in_pulmonary_disease/)
