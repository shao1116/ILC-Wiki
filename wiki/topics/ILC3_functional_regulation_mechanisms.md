...
- High confidence:
  human CD117+ ILCPs are a precursor compartment distinct from mature effector ILC3s, and adult human lung contains CD117+ ILC-lineage populations with ILCP activity as well as mature ILC3-like fractions. This supports human lung developmental/taxonomy context, not a pulmonary disease mechanism ([Systemic Human ILC Precursors Provide a Substrate for Tissue ILC Differentiation](../sources/2017_systemic_human_ilc_precursors_provide_a_substrate_for_tissue_ilc_differentiation.md)).
...
- [Systemic Human ILC Precursors Provide a Substrate for Tissue ILC Differentiation](../sources/2017_systemic_human_ilc_precursors_provide_a_substrate_for_tissue_ilc_differentiation.md) separates human CD117+ ILCPs from mature ILC3s and shows that adult lung CD117+ ILC-lineage populations include precursor activity. It also narrows the RORC boundary: RORC-deficient patient ILCPs retained NK/ILC1/ILC2 and IL-22+ ILC3 potential but failed to generate IL-17A+ ILC3s.
...
| [Human ILCP substrate for tissue ILC differentiation](../sources/2017_systemic_human_ilc_precursors_provide_a_substrate_for_tissue_ilc_differentiation.md) | CD117+ ILCP -> NK, ILC1, ILC2, and ILC3 outputs | Blood, adult lung, gut, tonsil, fetal liver, cord blood; humanized-mouse organs including lung | Human primary; humanized mouse transfer | Developmental/precursor biology; RORC-deficiency boundary | OP9/OP9-DL4 clonal culture, cytokine-conditioned differentiation, BRGS transfer, RORC-deficient patient analysis | Human ILCPs generate multiple ILC subsets; adult lung contains ILCP activity; RORC is required for IL-17A+ ILC3 generation in this source | Precursor potential and taxonomy evidence, not direct lung-disease effector causality. |
