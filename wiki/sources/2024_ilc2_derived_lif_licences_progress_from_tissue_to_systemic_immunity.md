...
- Main detected context: lung/airway, asthma/allergy, viral infection
...
- Evidence tags:
  #assay/KO #assay/RNAseq #assay/flow #cell/ILC1 #cell/ILC2 #cell/ILC3 #cell/T_cell #cell/macrophage #cell/monocyte #outcome/airway_hyperresponsiveness #outcome/homeostasis #outcome/infection #outcome/inflammation #outcome/repair #source/literature_pdf #species/human #species/mouse #tissue/gut #tissue/lung
- Detected biological focus: ILC2
- Detected mechanism or mediator terms: candidate mechanisms or mediators named in the source
- Detected context: lung/airway, asthma/allergy, viral infection

## Why It Matters Here

This source matters to the ILC-in-lung wiki because it appears to address lung/airway, asthma/allergy, viral infection with a focus on ILC2. For current synthesis, it should be used primarily as evidence for the source-specific claim that iLC2-derived LIF licences progress from tissue to systemic immunity, then upgraded or narrowed after manual review of the full methods, figures, and model system.

## Key Findings

- Here we show that disruption of leukaemia inhibitory factor (LIF) production from group 2 innate lymphoid cells (ILC2s) prevents immune cells leaving the lungs to migrate to the lymph nodes (LNs).
- In the absence of LIF , viral infection leads to plasmacytoid dendritic cells (pDCs) becoming retained in the lungs where they improve tissue-localized, antiviral immunity, whereas chronic pulmonary allergen challenge leads to marked immune cell accumulation and the formation of tertiary lymphoid structures in the lung.
- Mechanistically, ILC2-derived LIF induces the production of the chemokine CCL21 from lymphatic endothelial cells lining the pulmonary lymphatic vessels, thus licensing the homing of CCR7+ immune cells (including dendritic cells) to LNs.
- Consequently, ILC2-derived LIF dictates the egress of immune cells from the lungs to regulate tissue-localized versus systemic immunity and the balance between allergen and viral responsiveness in the lungs.
- The lungs are constantly exposed to the inhalation of both infectious and non-infectious agents.

## Claim-Level Confidence

- High confidence:
  this source directly supports the title/abstract-level claim that iLC2-derived LIF licences progress from tissue to systemic immunity.
- High confidence:
  the source is relevant to ILC2 in the detected context of lung/airway, asthma/allergy.
- Medium confidence:
...
- Tissue or disease context detected: lung/airway, asthma/allergy, viral infection
