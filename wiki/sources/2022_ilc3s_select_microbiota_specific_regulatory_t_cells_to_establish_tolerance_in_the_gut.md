...
- Verified title: ILC3s select microbiota-specific regulatory T cells to establish tolerance in the gut
- Publication year: 2022
- DOI: 10.1038/s41586-022-05141-x
- Metadata source: crossref-doi (confidence: high)
- Original local title: ILC3s select microbiota-specific regulatory T cells to establish tolerance in the gut
