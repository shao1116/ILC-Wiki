...
- High confidence:
  papain/protease-driven allergic lung pathology engages an IL-23/IL-17-associated innate lymphoid axis in this source.
- Medium-high confidence:
  ILC3-derived acetylcholine is a source-supported noncanonical mediator branch in this model.
- Medium confidence:
  this source is relevant to allergic lung pathology but should be interpreted as acute protease-driven disease, not all asthma.
- Low confidence:
  extension to chronic human asthma or therapeutic cholinergic targeting requires additional evidence.
