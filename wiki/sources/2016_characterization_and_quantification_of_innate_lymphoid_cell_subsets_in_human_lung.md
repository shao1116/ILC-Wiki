...
- High confidence:
  human lung tissue contains flow-defined ILC1, ILC2, and ILC3 subsets, including NCR+ and NCR- ILC3 compartments.
- High confidence:
  human pulmonary ILCs can express subset-associated cytokines after stimulation in this study.
- Medium confidence:
  COPD may be associated with a shift toward NCR- ILC3 and IL-17A/IL-22-positive ILCs, but this should be treated as trend-level because of limited sample size.
- Low confidence:
  this source alone does not establish causal ILC mechanisms in COPD progression or exacerbation.
