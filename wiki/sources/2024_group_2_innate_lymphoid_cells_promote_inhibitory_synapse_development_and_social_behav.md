...
- Verified title: Group 2 innate lymphoid cells promote inhibitory synapse development and social behavior
- Publication year: 2024
- DOI: 10.1126/science.adi1025
- Metadata source: crossref-doi (confidence: high)
- Original local title: Group 2 innate lymphoid cells promote inhibitory synapse development and social behavior
...
- Evidence tags:
  #assay/KO #assay/flow #assay/in_vivo #assay/scRNAseq #cell/ILC1 #cell/ILC2 #cell/NK #cell/T_cell #cell/macrophage #outcome/homeostasis #outcome/repair #source/literature_pdf #species/human #species/mouse #tissue/lung #tissue/skin
...
This source matters to the ILC-in-lung wiki because it appears to address nervous system with a focus on ILC2. For current synthesis, it should be used primarily as evidence for the source-specific claim that group 2 innate lymphoid cells promote inhibitory synapse development and social behavior, then upgraded or narrowed after manual review of the full methods, figures, and model system.

## Key Findings

- The title-level claim is that group 2 innate lymphoid cells promote inhibitory synapse development and social behavior.

## Claim-Level Confidence

- High confidence:
  this source directly supports the title/abstract-level claim that group 2 innate lymphoid cells promote inhibitory synapse development and social behavior.
- High confidence:
  the source is relevant to ILC2 in the detected context of nervous system.
- Medium confidence:
...
- Assay modalities detected from tags: flow cytometry, single-cell RNA-seq, in vivo model, genetic or knockout perturbation
