...
- Evidence tags:
  #assay/RNAseq #assay/in_vitro #assay/in_vivo #cell/ILC1 #cell/ILC2 #cell/ILC3 #cell/NK #cell/T_cell #cell/macrophage #outcome/airway_hyperresponsiveness #outcome/homeostasis #outcome/infection #outcome/repair #source/literature_pdf #species/human #species/mouse #tissue/gut #tissue/lung
...
This source matters to the ILC-in-lung wiki because it appears to address gut/intestine with a focus on T cells. For current synthesis, it should be used primarily as evidence for the source-specific claim that the interplay between innate lymphoid cells and T cells, then upgraded or narrowed after manual review of the full methods, figures, and model system.

## Key Findings

- How ILCs shape T-cell responses is strongly dependent on the tissue and in ﬂammatory context.
- Likewise, indirect regulation of ILCs by adaptive immunity is induced by environmental cues such as the gut microbiota.
- We discuss the diversity of functional interactions between T cells and ILCs during homeostasis and immune responses.

## Claim-Level Confidence

- High confidence:
  this source directly supports the title/abstract-level claim that the interplay between innate lymphoid cells and T cells.
- High confidence:
