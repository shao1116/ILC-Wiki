...
- Evidence tags:
  #assay/KO #cell/B_cell #cell/ILC1 #cell/ILC2 #cell/ILC3 #cell/NK #cell/T_cell #cell/macrophage #outcome/airway_hyperresponsiveness #outcome/homeostasis #outcome/infection #outcome/inflammation #outcome/repair #source/literature_pdf #species/human #species/mouse #tissue/gut #tissue/lung #tissue/nasal_polyp
...
This source matters to the ILC-in-lung wiki because it appears to address tumor/cancer with a focus on NK cells. For current synthesis, it should be used primarily as evidence for the source-specific claim that innate lymphoid cells major players in inflammatory diseases, then upgraded or narrowed after manual review of the full methods, figures, and model system.

## Key Findings

- The emerging field of innate lymphoid cell (ILC) biol- ogy has progressed rapidly, with many studies suggest- ing important roles for these cells in immunity, tissue development and remodelling1–8.
- ILCs have been cate- gorized into three main groups based on their similarity to T helper (T H) cell subsets9 (FIG.
- In this Review, we do not focus on the biology of lymphoid tissue-inducer (LTi) cells and natural killer (NK) cells or the roles of ILCs in cancer10–14, pregnancy15 or transplantation 16.
- Instead, we focus on the role of ILC1s, ILC2s and ILC3s in autoimmune and inflamma- tory diseases affecting various tissues.
- In particular, we focus on human data and discuss potential therapeutic strategies for targeting ILCs in inflammatory disease.

## Claim-Level Confidence

- High confidence:
  this source directly supports the title/abstract-level claim that innate lymphoid cells major players in inflammatory diseases.
- High confidence:
  the source is relevant to NK cells in the detected context of tumor/cancer.
- Medium confidence:
