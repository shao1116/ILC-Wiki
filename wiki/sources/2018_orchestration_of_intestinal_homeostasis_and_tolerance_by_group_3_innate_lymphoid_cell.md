...
- Verified title: Orchestration of intestinal homeostasis and tolerance by group 3 innate lymphoid cells
- Publication year: 2018
- DOI: 10.1007/s00281-018-0687-8
- Metadata source: crossref-doi (confidence: high)
- Original local title: Orchestration of intestinal homeostasis and tolerance by group 3 innate lymphoid cells
...
- Evidence tags:
  #assay/RNAseq #assay/scRNAseq #cell/B_cell #cell/ILC1 #cell/ILC2 #cell/ILC3 #cell/T_cell #cell/macrophage #outcome/homeostasis #outcome/infection #outcome/inflammation #outcome/repair #source/literature_pdf #species/human #species/mouse #tissue/gut #tissue/lung
...
This source matters to the ILC-in-lung wiki because it appears to address gut/intestine with a focus on ILC3. For current synthesis, it should be used primarily as evidence for the source-specific claim that orchestration of intestinal homeostasis and tolerance by group 3 innate lymphoid cells, then upgraded or narrowed after manual review of the full methods, figures, and model system.

## Key Findings

- Intestinal homeostasis and tolerance are mediated through a multitude of immune mechanisms that act to reinforce barrier integrity, maintain the segregation and balance of commensal microbes, and ensure tissue health and regener- ation.
- Here, we discuss the role of group 3 innate lymphoid cells (ILC3) as key regulators of intestinal health and highlight how increasing evidence implicates dysregulation of this innate immune cell population in the onset or progression of a broad range of clinically relevant pathologies.
- Finally, we discuss how the next generation of immunotherapeutics may be utilized to target ILC3 in disease and restore gastrointestinal tolerance and tissue health.

## Claim-Level Confidence

- High confidence:
  this source directly supports the title/abstract-level claim that orchestration of intestinal homeostasis and tolerance by group 3 innate lymphoid cells.
- High confidence:
...
- Assay modalities detected from tags: single-cell RNA-seq, RNA-seq
