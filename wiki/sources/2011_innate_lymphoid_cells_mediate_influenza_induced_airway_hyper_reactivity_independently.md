...
- High confidence:
  influenza A can drive acute AHR in this mouse model through innate lymphoid/natural helper cells rather than adaptive TH2 cells.
- High confidence:
  IL-33 and IL-13 are central to the airway hyper-reactivity mechanism in this source.
- Medium confidence:
  this source maps well onto modern lung ILC2 biology, but historical nomenclature should be preserved when making precise claims.
- Low confidence:
  direct extension to human asthma or chronic post-viral airway disease requires additional human or translational support.
