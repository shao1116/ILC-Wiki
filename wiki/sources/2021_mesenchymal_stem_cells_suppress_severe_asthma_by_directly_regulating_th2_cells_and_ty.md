...
- Verified title: Mesenchymal Stem Cells Suppress Severe Asthma by Directly Regulating Th2 Cells and Type 2 Innate Lymphoid Cells
- Publication year: 2021
- DOI: 10.14348/molcells.2021.0101
- Metadata source: crossref-doi (confidence: high)
- Original local title: Mesenchymal Stem Cells Suppress Severe Asthma by Directly Regulating Th2 Cells and Type 2 Innate Lymphoid Cells
...
- Evidence tags:
  #assay/flow #assay/in_vitro #assay/in_vivo #cell/ILC2 #cell/T_cell #cell/macrophage #outcome/airway_hyperresponsiveness #outcome/inflammation #source/literature_pdf #species/human #species/mouse #tissue/lung
...
This source matters to the ILC-in-lung wiki because it appears to address lung/airway, asthma/allergy with a focus on ILC2. For current synthesis, it should be used primarily as evidence for the source-specific claim that mesenchymal Stem Cells Suppress Severe Asthma by Directly Regulating Th2 Cells and Type 2 Innate Lymphoid Cells, then upgraded or narrowed after manual review of the full methods, figures, and model system.

## Key Findings

- Patients with severe asthma have unmet clinical needs for effective and safe therapies.
- One possibility may be mesenchymal stem cell (MSC) therapy, which can improve asthma in murine models.
- However, it remains unclear how MSCs exert their beneficial effects in asthma.
- Here, we examined the effect of human umbilical cord blood-derived MSCs (hUC-MSC) on two mouse models of severe asthma, namely, Alternaria alternata-induced and house dust mite (HDM)/diesel exhaust particle (DEP)-induced asthma. hUC- MSC treatment attenuated lung type 2 (Th2 and type 2 innate lymphoid cell) inflammation in both models.
- In vitro co-culture showed that hUC- MSC directly downregulated the interleukin (IL)-5 and IL-13 production of differentiated mouse Th2 cells and peripheral blood mononuclear cells from asthma patients.

## Claim-Level Confidence

- High confidence:
  this source directly supports the title/abstract-level claim that mesenchymal Stem Cells Suppress Severe Asthma by Directly Regulating Th2 Cells and Type 2 Innate Lymphoid Cells.
- High confidence:
