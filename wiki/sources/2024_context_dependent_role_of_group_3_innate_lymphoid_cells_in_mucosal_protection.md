...
- Verified title: Context-dependent role of group 3 innate lymphoid cells in mucosal protection
- Publication year: 2024
- DOI: 10.1126/sciimmunol.ade7530
- Metadata source: crossref-title (confidence: high)
- Original local title: Context-dependent role of group 3 innate lymphoid cells in mucosal protection
...
- Evidence tags:
  #assay/KO #assay/RNAseq #cell/ILC3 #cell/T_cell #outcome/homeostasis #outcome/infection #source/literature_pdf #species/mouse #tissue/gut
...
This source matters to the ILC-in-lung wiki because it appears to address gut/intestine with a focus on ILC3, T cells. For current synthesis, it should be used primarily as evidence for the source-specific claim that context-dependent role of group 3 innate lymphoid cells in mucosal protection, then upgraded or narrowed after manual review of the full methods, figures, and model system.

## Key Findings

- Ivanov1,5* How group 3 innate lymphoid cells (ILC3s) regulate mucosal protection in the presence of T cells remains poorly understood.
- Here, we examined ILC3 function in intestinal immunity using ILC3- deficient mice that maintain en- dogenous T cells, T helper 17 (TH17) cells, and secondary lymphoid organs.
- ILC3s were dispensable for generation of TH17 and TH22 cell responses to commensal and pathogenic bacteria, and absence of ILC3s did not affect IL- 22 production by CD4 T cells before or during infection.
- However, despite the presence of IL- 22–producing T cells, ILC3s and ILC3- derived IL- 22 were required for maintaining homeostatic functions of the intestinal epithelium.
- T cell–sufficient, ILC3- deficient mice were capable of pathogen clearance and survived infection with a low dose of Citrobacter rodentium.

## Claim-Level Confidence

- High confidence:
  this source directly supports the title/abstract-level claim that context-dependent role of group 3 innate lymphoid cells in mucosal protection.
- High confidence:
