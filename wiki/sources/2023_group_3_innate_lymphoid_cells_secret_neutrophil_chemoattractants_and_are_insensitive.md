...
- High confidence:
  human ILC3s are increased in the peripheral blood of non-eosinophilic asthma patients in this cohort.
- High confidence:
  IL-1beta can induce ILC3 neutrophil chemoattractants CXCL8 and CXCL1 in vitro and these responses are dexamethasone-insensitive in the source assays.
- Medium confidence:
  the GR phosphorylation mechanism is source-supported but should be checked carefully before being treated as the sole cause of steroid resistance.
- Low confidence:
  this source alone does not prove lung-resident ILC3s drive all neutrophilic asthma pathology in vivo.
