...
- IL-33 claims need source-cell labels: mouse intestinal helminth evidence shows epithelial IL-33 supporting ILC2-associated type 2 protection, while CD11c+ APC-derived IL-33 supports ST2+GATA3+Foxp3+ Treg restraint; this is gut/MLN mechanism context, not direct lung-disease causality.
...
- APC-derived IL-33 can also support ST2+GATA3+Foxp3+ Treg restraint in mouse intestinal helminth immunity, while epithelial IL-33 supports ILC2-associated type 2 protection in the same source.
- After airway allergen sensitization in mice, ILC2s can also act in lung-draining lymph nodes: CCR8-guided ILC2 trafficking and ILC2-derived IL-4 support Tfh13 differentiation, high-affinity IgE, and anaphylaxis-associated outputs. This branch should remain compartment-labeled as draining-lymph-node adaptive immunity rather than direct human lung tissue evidence.
...
- Human adult lung contains CD117+ ILC-lineage populations with ILCP activity, supporting a precursor/tissue-differentiation boundary that should remain separate from mature ILC3 effector claims.
...
- Activated peripheral/splenic ILC3s provide an additional adaptive-immunity branch in which IL-1beta/TLR-conditioned NCR- ILC3s use MHCII and costimulatory molecules to promote CD4 T-cell and T-dependent B-cell responses; this contrasts with gut tolerogenic ILC3-MHCII outputs.
- Gut eosinophil-derived COX-2/PGE2 can enhance colonic ILC3 IL-22 through EP4 in mouse colitis, adding a lipid-mediator crosstalk layer for ILC3 barrier-protective output.
- High IL-33 can activate splenic ILC2s to expand red pulp macrophages through IL-4/IL-13 and GM-CSF, broadening ILC2-macrophage crosstalk beyond lung macrophage niche remodeling.
...
- Gut/mucosal ILC3 evidence includes RANKL/RANK restraint, BMAL1 and light/brain circadian timing, FFAR2 metabolite sensing, VIP receptor-context neuroimmune circuits, trained defense states, and HB-EGF tissue protection; these are useful regulatory comparators rather than direct pulmonary evidence.
...
- Human ILCP evidence adds a developmental/taxonomy guardrail: CD117+ ILCPs can generate NK, ILC1, ILC2, and ILC3 outputs, and RORC-deficient patient ILCPs fail to generate IL-17A+ ILC3s while retaining other lineage potentials.
...
- [Group 2 innate lymphoid cells promote inhibitory synapse development and social behavior](../sources/2024_group_2_innate_lymphoid_cells_promote_inhibitory_synapse_development_and_social_behav.md)
...
- [Innate lymphoid cells integrate sensing and plasticity to control fungal infections](../sources/2026_innate_lymphoid_cells_integrate_sensing_and_plasticity_to_control_fungal_infections.md)
...
- [IL-9 and Blimp-1 protect the transcriptional identity of group 2 innate lymphocytes in allergic asthma](../sources/2026_il_9_and_blimp_1_protect_the_transcriptional_identity_of_group_2_innate_lymphocytes_in_allergic_asthma.md)
- [Severe asthma is characterized by a sex-specific ILC landscape and aberrant airway profile that is suppressed by anti-IL-5/5Ralpha biologics](../sources/2025_severe_asthma_is_characterized_by_a_sex_specific_ilc_landscape_and_aberrant_airway_pr.md)
...
- [IL-33-induced ILC2 effector cytokine responses promote the expansion of red pulp macrophages](../sources/2026_il_33_induced_ilc2_effector_cytokine_responses_promote_the_expansion_of_red_pulp_macr.md)
...
- [Tissue-Restricted Adaptive Type 2 Immunity Is Orchestrated by Expression of the Costimulatory Molecule OX40L on Group 2 Innate Lymphoid Cells](../sources/2018_tissue_restricted_adaptive_type_2_immunity_is_orchestrated_by_expression_of_the_costimulatory_molecule_ox40l_on.md)
- [Cellular context of IL-33 expression dictates impact on anti-helminth immunity](../sources/2020_cellular_context_of_il_33_expression_dictates_impact_on_anti_helminth_immunity.md)
...
- [Regulatory Innate Lymphoid Cells Control Innate Intestinal Inflammation](../sources/2017_regulatory_innate_lymphoid_cells_control_innate_intestinal_inflammation.md)
...
- [Dysregulation of ILC3s unleashes progression and immunotherapy resistance in colon cancer](../sources/2021_dysregulation_of_ilc3s_unleashes_progression_and_immunotherapy_resistance_in_colon_cancer.md)
- [ILC3s sense gut microbiota through STING to initiate immune tolerance](../sources/2025_ilc3s_sense_gut_microbiota_through_sting_to_initiate_immune_tolerance.md)
...
- [Microbial dysbiosis sculpts a systemic ILC3/IL-17 axis governing lung inflammatory responses and central hematopoiesis](../sources/2025_microbial_dysbiosis_sculpts_a_systemic_ilc3_il_17_axis_governing_lung_inflammatory_re.md)
...
- [BACH2 controls ILC3 function via PPARgamma-dependent mitochondrial metabolism](../sources/2026_bach2_controls_ilc3_function_via_ppargamma_dependent_mitochondrial_metabolism.md)
- [LINGO4 coordinates ILC3-intrinsic IL-22 production and microbiota-mediated ILC3 homeostasis](../sources/2026_lingo4_coordinates_ilc3_intrinsic_il_22_production_and_microbiota_mediated_ilc3_homeostasis.md)

- [Eosinophil-derived COX-2 protects against experimental colitis through the PGE2-IL-22 axis](../sources/2026_eosinophil_derived_cox_2_protects_against_experimental_colitis_through_the_pge2_il_22.md)
...
- [Subsets of ILC3-ILC1-like cells generate a diversity spectrum of innate lymphoid cells in human mucosal tissues](../sources/2019_subsets_of_ilc3_ilc1_like_cells_generate_a_diversity_spectrum_of_innate_lymphoid_cell.md)
- [ZBTB46 defines and regulates ILC3s that protect the intestine](../sources/2022_zbtb46_defines_and_regulates_ilc3s_that_protect_the_intestine.md)
- [Context-dependent role of group 3 innate lymphoid cells in mucosal protection](../sources/2024_context_dependent_role_of_group_3_innate_lymphoid_cells_in_mucosal_protection.md)
- [Circadian circuits control plasticity of group 3 innate lymphoid cells by sustaining epigenetic configuration of RORgammat](../sources/2025_circadian_circuits_control_plasticity_of_group_3_innate_lymphoid_cells_by_sustaining_epigenetic_configuration_of.md)
- [Enteric GABAergic neuron-derived gamma-aminobutyric acid initiates expression of Igfbp7 to sustain ILC3 homeostasis](../sources/2025_enteric_gabaergic_neuron_derived_gamma_aminobutyric_acid_initiates_expression_of_igfbp7_to_sustain_ilc3_homeosta.md)
- [ILC3s promote intestinal tuft cell hyperplasia and anthelmintic immunity through RANK signaling](../sources/2025_ilc3s_promote_intestinal_tuft_cell_hyperplasia_and_anthelmintic_immunity_through_rank.md)
- [Recruitment and activation of type 3 innate lymphoid cells promote antitumor immune responses](../sources/2022_recruitment_and_activation_of_type_3_innate_lymphoid_cells_promote_antitumor_immune_r.md)
...
- [Metabolite-Sensing Receptor Ffar2 Regulates Colonic Group 3 Innate Lymphoid Cells and Gut Immunity](../sources/2019_metabolite_sensing_receptor_ffar2_regulates_colonic_group_3_innate_lymphoid_cells_and.md)
- [Feeding-dependent VIP neuron-ILC3 circuit regulates the intestinal barrier](../sources/2020_feeding_dependent_vip_neuron_ilc3_circuit_regulates_the_intestinal_barrier.md)
- [The neuropeptide VIP confers anticipatory mucosal immunity by regulating ILC3 activity](../sources/2020_the_neuropeptide_vip_confers_anticipatory_mucosal_immunity_by_regulating_ilc3_activit.md)
- [Vasoactive intestinal peptide promotes host defense against enteric pathogens by modulating the recruitment of group 3 innate lymphoid cells](../sources/2021_vasoactive_intestinal_peptide_promotes_host_defense_against_enteric_pathogens_by_modu.md)
- [Trained ILC3 responses promote intestinal defense](../sources/2022_trained_ilc3_responses_promote_intestinal_defense.md)
- [Group 3 innate lymphoid cells produce the growth factor HB-EGF to protect the intestine from TNF-mediated inflammation](../sources/2022_group_3_innate_lymphoid_cells_produce_the_growth_factor_hb_egf_to_protect_the_intestine_from_tnf_mediated_inflam.md)
- [Activation and Suppression of Group 3 Innate Lymphoid Cells in the Gut](../sources/2020_activation_and_suppression_of_group_3_innate_lymphoid_cells_in_the_gut.md)
...
- [Systemic Human ILC Precursors Provide a Substrate for Tissue ILC Differentiation](../sources/2017_systemic_human_ilc_precursors_provide_a_substrate_for_tissue_ilc_differentiation.md)
