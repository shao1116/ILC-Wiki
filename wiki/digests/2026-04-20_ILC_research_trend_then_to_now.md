...
| Current wiki synthesis | The field is mature enough that a useful wiki must separate source type, species, tissue compartment, disease model, assay, and claim confidence. | Lung ILC knowledge is now best navigated as an evidence map: ILC2 versus ILC3, protective versus pathogenic state, mouse perturbation versus human association, acute infection versus chronic asthma endotype. | [Lung ILC Core Evidence Synthesis](./2026-04-22_lung_ILC_core_evidence_synthesis.md), [ILC2 Working Model](./2026-04-20_ILC2_working_model.md), [ILC3 Working Model](./2026-04-20_ILC3_working_model.md), [ILC In Pulmonary Diseases](./2026-04-20_ILC_pulmonary_disease_roles.md) |
...
4. Read the ILC2 and ILC3 working model digests to see how disease mechanisms are organized in this wiki.
5. Use the Lung ILC Core Evidence Synthesis as the current integrated map, especially when deciding whether a claim is mouse-causal, human-associative, review-level, or provisional.
...
- [ILC2 Working Model](./2026-04-20_ILC2_working_model.md)
- [ILC3 Working Model](./2026-04-20_ILC3_working_model.md)
- [ILC In Pulmonary Diseases](./2026-04-20_ILC_pulmonary_disease_roles.md)
