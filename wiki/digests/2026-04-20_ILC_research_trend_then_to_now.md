...
| Current wiki synthesis | The field is mature enough that a useful wiki must separate source type, species, tissue compartment, disease model, assay, and claim confidence. | Lung ILC knowledge is now best navigated as an evidence map: canonical cell hubs for ILC2 and ILC3, one core cross-subset synthesis, and one disease-first companion page. | [Lung ILC Core Evidence Synthesis](./2026-04-22_lung_ILC_core_evidence_synthesis.md), [ILC2](../entities/ILC2.md), [ILC3](../entities/ILC3.md), [Lung ILC Disease Roles Companion](./2026-04-20_ILC_pulmonary_disease_roles.md) |
