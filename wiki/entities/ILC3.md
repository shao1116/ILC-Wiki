...
- Activated splenic/peripheral ILC3s can show the opposite adaptive output: after IL-1beta or TLR stimulation, mouse NCR- ILC3s upregulate MHCII and costimulatory molecules, prime CD4 T cells, and support T-dependent B-cell antibody responses. This reinforces that ILC3 antigen-presentation outcome is tissue- and activation-state dependent ([Activated group 3 innate lymphoid cells promote T-cell-mediated immune responses](../sources/2014_activated_group_3_innate_lymphoid_cells_promote_t_cell_mediated_immune_responses.md)).
