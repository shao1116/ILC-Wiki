...
- High confidence: adult human lung also contains CD117+ ILC-lineage populations with ILCP activity, alongside mature ILC3-like fractions. This supports precursor/tissue-differentiation context and helps avoid treating every CD117+ ILC-lineage cell as mature ILC3 ([Systemic Human ILC Precursors Provide a Substrate for Tissue ILC Differentiation](../sources/2017_systemic_human_ilc_precursors_provide_a_substrate_for_tissue_ilc_differentiation.md)).
...
- Medium-high confidence: activated peripheral/splenic NCR- ILC3s can acquire MHCII and costimulatory capacity after IL-1beta/TLR stimulation and promote antigen-specific CD4 T-cell and T-dependent B-cell responses in mouse systems; this is adaptive-immunity context, not direct lung evidence ([Activated group 3 innate lymphoid cells promote T-cell-mediated immune responses](../sources/2014_activated_group_3_innate_lymphoid_cells_promote_t_cell_mediated_immune_responses.md)).
- Medium confidence: extrapulmonary ILC3 antigen-presentation outcomes can diverge by context, including gut tolerance, CNS neuroinflammation, and colon-cancer immunotherapy response; RORgammat-positive DC lineage data add an attribution boundary for Treg-related mechanisms ([Antigen-presenting innate lymphoid cells orchestrate neuroinflammation](../sources/2021_antigen_presenting_innate_lymphoid_cells_orchestrate_neuroinflammation.md); [Dysregulation of ILC3s unleashes progression and immunotherapy resistance in colon cancer](../sources/2021_dysregulation_of_ilc3s_unleashes_progression_and_immunotherapy_resistance_in_colon_cancer.md); [RORgammat+ dendritic cells are a distinct lymphoid-derived lineage](../sources/2026_rorgammat_dendritic_cells_are_a_distinct_lymphoid_derived_lineage.md)).
...
The human baseline branch now includes a precursor boundary: adult human lung CD117+ ILC-lineage populations can include ILCP activity as well as mature ILC3-like cells. ILCP potential should be kept separate from mature effector ILC3 disease mechanisms.
...
- Fungal infection branch: pulmonary ILCs can sense fungal components and influence Aspergillus lung infection outcomes, with inflammatory cytokines supporting ILC3-like skewing in the reported mouse system ([Innate lymphoid cells integrate sensing and plasticity to control fungal infections](../sources/2026_innate_lymphoid_cells_integrate_sensing_and_plasticity_to_control_fungal_infections.md)).
...
- Activated splenic/peripheral ILC3s can show the opposite adaptive output: after IL-1beta or TLR stimulation, mouse NCR- ILC3s upregulate MHCII and costimulatory molecules, promote antigen-specific CD4 T-cell activation/proliferation, and support T-dependent antibody responses. This reinforces that ILC3 antigen-presentation outcome is tissue- and activation-state dependent ([Activated group 3 innate lymphoid cells promote T-cell-mediated immune responses](../sources/2014_activated_group_3_innate_lymphoid_cells_promote_t_cell_mediated_immune_responses.md)).
...
- High confidence: human CD117+ ILCPs are distinct from mature ILC3s and can generate NK, ILC1, ILC2, and ILC3 outputs under source-specific assay conditions. RORC-deficient patient ILCPs retained several ILC potentials but failed to generate IL-17A+ ILC3s, keeping the RORC boundary focused on IL-17A+ ILC3 generation rather than global ILCP absence ([Systemic Human ILC Precursors Provide a Substrate for Tissue ILC Differentiation](../sources/2017_systemic_human_ilc_precursors_provide_a_substrate_for_tissue_ilc_differentiation.md)).
