...
This entity page defines group 2 innate lymphoid cells (ILC2s) as they are used in the ILC-in-lung wiki. It is a hub for disease roles, regulatory mechanisms, and source routing rather than a complete textbook entry.
...
## Core Identity and Disease Branches
...
### Viral disease, repair, and macrophage niche effects
...
## Regulatory Mechanisms and Boundary States

### Neuroimmune and metabolic control
...
### Noncanonical contexts and IL-17 boundary states
...
### Spatial niche, interferon brake, and type 2 circuit layer
...
- [ILC2 working model digest](../digests/2026-04-20_ILC2_working_model.md)
- [ILC pulmonary disease digest](../digests/2026-04-20_ILC_pulmonary_disease_roles.md)
